...
def ban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    try:
        ...
        message.reply_text("baneadisimo") #Original: Banned!
        return log
        ...
        if excp.message == "Reply message not found":
            ...
            LOGGER.exception("ERROR baneando a %s en el chat %s (%s) debido a %s", user_id, chat.title, chat.id,
                             excp.message) #Original: ERRROR banning user %s in chat %s (%s) due to %s
...
def temp_ban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    try:
        ...
        if excp.message == "Reply message not found":
            ...
            LOGGER.warning(update)
            LOGGER.exception("ERROR baneando a %s en el chat %s (%s) debido a %s", user_id, chat.title, chat.id,
                             excp.message) #Original: ERROR banning user %s in chat %s (%s) due to %s
            message.reply_text("alv no pude") #Original: Well damn, I can't ban that user.
